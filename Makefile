...
external-tag-and-push-80: up2date
	...
	docker manifest create vemcogroup/php-cli:8.0-test --amend vemcogroup/php-cli:8.0-amd64 --amend vemcogroup/php-cli:8.0-arm64
	docker manifest push vemcogroup/php-cli:8.0-test
